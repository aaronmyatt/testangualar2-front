describe('App', function() {
  ...
  it('should have correct nav text for Points', function() {
    expect(element(by.css('sd-app sd-navbar nav a:last-child')).getText()).toEqual('POINTS');
  });

  //it('should have correct nav text for Maps', function() {
  //  expect(element(by.css('sd-app sd-navbar nav a:last-child')).getText()).toEqual('POINTS');
  //});
